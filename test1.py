...
if __name__ == '__main__':
	...
	for i in range(len(test_data)):
		...
		label = ''
		if(results[0] > results[1] and results[0] > results[2] and results[0] > results[3] and results[0] > results[4] and results[0] > results[5] ):
			label = 'ram'
		elif(results[1] > results[0] and results[1] > results[2] and results[1] > results[3] and results[1] > results[4] and results[1] > results[5]):
			label = 'shyam'
		elif(results[2] > results[0] and results[2] > results[1] and results[2] > results[3] and results[2] > results[4] and results[2] > results[5]):
			label = 'krishna'
		elif(results[3] > results[0] and results[3] > results[1] and results[3] > results[2] and results[3] > results[4] and results[3] > results[5]):
			label = 'hari'
		elif(results[4] > results[0] and results[4] > results[1] and results[4] > results[2] and results[4] > results[3] and results[4] > results[5]):
			label = 'rita'
		else:
			label = 'rajan'
